...
static int __init mychardev_init(void)
{
    ...
    printk("Constructing Character drivers mychardev-0 mychardev-1\n");
...
static void __exit mychardev_exit(void)
{
    ...
    printk("destroying Character drivers mychardev-0 mychardev-1\n");
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Ibrahim Pasha <ibrahimpasha112@gmail.com>");
